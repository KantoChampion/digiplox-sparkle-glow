    ...
    extend: {
      ...
      keyframes: {
        ...
        "glitch-flicker": {
          ...
          "41%": { opacity: "1", transform: "translate(0)" },
          "42%": { opacity: "0.6", transform: "translate(3px, 0) skewX(-2deg)" },
          "43%": { opacity: "1", transform: "translate(0) skewX(0)" },
          "44%": { opacity: "0.9", transform: "translate(-1px, 0)" },
          "45%": { opacity: "1", transform: "translate(0)" },
          "80%": { opacity: "1", transform: "translate(0)" },
          "81%": { opacity: "0.7", transform: "translate(2px, -1px) skewX(1deg)" },
          "82%": { opacity: "1", transform: "translate(0) skewX(0)" },
        },
        "neon-breathe": {
      ...
      animation: {
        ...
        "glitch-flicker": "glitch-flicker 5s ease-in-out infinite",
